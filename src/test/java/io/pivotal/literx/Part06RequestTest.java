...
class Part06RequestTest {
    ...
    @Test
    void requestAll() {
        StepVerifier verifier = workshop.requestAllExpectFour(repository.findAll());
        verifier.verify();
    }
    ...
    void requestOneByOne() {
        StepVerifier verifier = workshop.requestOneExpectSkylerThenRequestOneExpectJesse(repository.findAll());
        verifier.verify();
    }
